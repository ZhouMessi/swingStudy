...
public class MainFrm extends JFrame {
	...
	public MainFrm() throws Exception {
		...
		setJMenuBar(menuBar);
		//设置图标
		setIconImage(Toolkit.getDefaultToolkit().getImage(MainFrm.class.getResource("/images/moneyPage.png")));
		
		JMenu mnNewMenu = new JMenu("\u8D22\u52A1\u7BA1\u7406");
		mnNewMenu.setIcon(new ImageIcon(MainFrm.class.getResource("/images/money.png")));
		menuBar.add(mnNewMenu);
		
		JMenu mnNewMenu_1 = new JMenu("\u56FE\u4E66\u7BA1\u7406");
		mnNewMenu_1.setIcon(new ImageIcon(MainFrm.class.getResource("/images/dingGou.png")));
		...
		mntmNewMenuItem_1.setIcon(new ImageIcon(MainFrm.class.getResource("/images/add_dinggoudan.png")));
		...
		mntmNewMenuItem_2.setIcon(new ImageIcon(MainFrm.class.getResource("/images/weihu.png")));
		...
		mntmNewMenuItem_3.setIcon(new ImageIcon(MainFrm.class.getResource("/images/weihu.png")));
		...
		menu.setIcon(new ImageIcon(MainFrm.class.getResource("/images/guanYuWoMen.png")));
		menuBar.add(menu);
		...
		mntmNewMenuItem.setIcon(new ImageIcon(MainFrm.class.getResource("/images/qiye.png")));
		menu.add(mntmNewMenuItem);
		
		JMenu menu_1 = new JMenu("\u7CFB\u7EDF\u8BBE\u7F6E");
		menu_1.setIcon(new ImageIcon(MainFrm.class.getResource("/images/xitongshezhi.png")));
		menuBar.add(menu_1);
		...
		menuItem.setIcon(new ImageIcon(MainFrm.class.getResource("/images/anquantuichu.png")));
		menu_1.add(menuItem);
